...
from src.models.schemas import ContextAnalysisResult, RelatedArticleReference, SummarizedArticle
...
class ContextAnalyzer:
    ...
    async def _generate_simple_japanese_title(self, title: str) -> str | None:
