...
def test_domain_classifications():
    ...
    assert is_official_domain("openai.com")
    assert not is_official_domain("example.com")
    assert is_reputable_domain("techcrunch.com")
    assert not is_reputable_domain("example.com")
...
def test_constants_consistency():
    ...
    from src.constants.settings import NEWSLETTER, TEXT_LIMITS
